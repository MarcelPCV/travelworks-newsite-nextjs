...
export default function HeroPage({ block, className }: HeroPageProps) {
        ...
        <div className="grid w-full lg:min-h-140 lg:grid-cols-[1fr_1.22fr] lg:gap-8 lg:py-3">
          <div className="flex flex-col lg:justify-center">
            <div className="px-6 pb-10 pt-4 text-center sm:px-10 sm:pb-12 lg:px-0 lg:pb-0 lg:pt-0">
              ...
              {logoImage && (
                <div className="mx-auto w-full max-w-65 sm:max-w-70 lg:max-w-57.5">
                  <ImageSlot
                    src={logoImage.url}
                    alt=""
                    className="aspect-11/5 w-full bg-violet-500"
                  />
                </div>
              )}
              ...
              {description ? (
                <div className="mx-auto mt-4 max-w-[22ch] text-[2rem] leading-tight text-neutral-dark sm:max-w-[24ch] sm:text-[2.2rem] lg:mt-5 lg:text-[2.35rem]">
              ...
              {secondaryImage && (
                <div className="mx-auto mt-10 w-full max-w-65 sm:max-w-70 lg:mt-12 lg:max-w-57.5">
                  <ImageSlot
                    ...
                    alt=""
                    className="aspect-11/5 w-full bg-yellow-500"
                  />
                </div>
              )}
            </div>
          ...
          {mainImage && (
            <div className="relative hidden items-center justify-center lg:flex">
              <ImageSlot
                src={mainImage.url}
                alt=""
                className="h-[86%] w-full max-w-215 bg-green-500"
                priority
              />
            </div>
          )}
