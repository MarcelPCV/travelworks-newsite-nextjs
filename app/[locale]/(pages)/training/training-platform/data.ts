...
const cards: InfoCard[] = [
  {
    ...
    description: 'block-type-info-cards.0.description',
    icon: GraduationCap,
    cta: false,
  ...
  },
  {
    ...
    description: 'block-type-info-cards.1.description',
    icon: BadgeCheck,
    cta: false,
    ctaLabel: 'block-type-info-cards.1.ctaLabel',
    ctaLink: 'block-type-info-cards.1.ctaLink',
  },
  {
    title: 'block-type-info-cards.2.title',
    description: 'block-type-info-cards.2.description',
    icon: FileBarChart,
    cta: false,
    ctaLabel: 'block-type-info-cards.2.ctaLabel',
    ctaLink: 'block-type-info-cards.2.ctaLink',
  },
  {
    title: 'block-type-info-cards.3.title',
    description: 'block-type-info-cards.3.description',
    icon: ClipboardList,
    cta: false,
    ctaLabel: 'block-type-info-cards.3.ctaLabel',
    ctaLink: 'block-type-info-cards.3.ctaLink',
  },
  {
    title: 'block-type-info-cards.4.title',
    description: 'block-type-info-cards.4.description',
    icon: MonitorSmartphone,
    cta: true,
    ctaLabel: 'block-type-info-cards.4.ctaLabel',
    ctaLink: 'block-type-info-cards.4.ctaLink',
  },
];
