...
import { NewsListPage } from '@/app/[locale]/news/news-list-page';
import { getAllArticles, getListAlternates, getRouteLocales } from '@/app/[locale]/news/lib/news';
import { getNewsLabels } from '@/app/[locale]/news/lib/labels';
import { generateNewsMetadata } from '@/app/[locale]/news/lib/seo';
