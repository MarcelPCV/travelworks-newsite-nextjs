...
export default function PlatformShowcase({
  ...
  return (
    <div className="relative mx-auto flex w-full flex-col gap-8 bg-brand-blue py-8">
      {title && (
        <h2 className="text-center text-3xl font-medium uppercase tracking-tight sm:text-4xl text-white">
          {title}
        </h2>
      )}
      <div className="relative">
        <div className="mx-auto max-w-4xl rounded-2xl">
          <div className="flex items-center justify-center rounded-xl w-full h-auto">
            <Image src={mainImage} alt="" width={800} height={400} className="w-full h-auto" />
          </div>
        </div>
      </div>
