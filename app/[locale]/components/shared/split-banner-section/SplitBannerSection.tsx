...
export default function SplitBannerSection({
  ...
  const rootBaseClasses = [`w-full mx-auto max-w-7xl rounded-[2rem]  py-5 sm:py-6 lg:py-8`].join(
    ' ',
  );
  ...
  return (
    <section className={`${rootBaseClasses} ${className}`} aria-labelledby={headingId}>
      <h2 className="flex justify-center text-blue-800 text-4xl uppercase pb-10">{title}</h2>
      <div
