...
- Name: navbar-menu.spec.ts >> Navbar mega menu >> shows About Us and Training dropdown menus on click only
- Location: e2e\navbar-menu.spec.ts:18:7
...
Call log:
  - waiting for getByRole('button', { name: 'About Us' })
