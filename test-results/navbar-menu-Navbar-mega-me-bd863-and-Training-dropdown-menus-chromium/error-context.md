...
- Name: navbar-menu.spec.ts >> Navbar mega menu >> shows About Us and Training dropdown menus
- Location: e2e\navbar-menu.spec.ts:20:7
...
Locator: getByRole('link', { name: 'Travelworks Company' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: 'Travelworks Company' })
  ...
  - navigation:
    ...
    - list:
      - listitem:
        - button "Products"
      - listitem:
        - button "About Us" [expanded]
        - menu "About Us":
          - menuitem "Travelworks Company"
          - menuitem "Clients"
          - menuitem "Partners"
          - menuitem "Contact"
      - listitem:
